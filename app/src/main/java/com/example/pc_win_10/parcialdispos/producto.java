...
public class producto extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        indexView= inflater.inflate(R.layout.fragment_producto, container, false);
        nombre = (EditText)indexView.findViewById(R.id.Nombre);
        valor = (EditText)indexView.findViewById(R.id.Precio);
        registrar = (Button)indexView.findViewById(R.id.Registrar);
        spinner = (Spinner) indexView.findViewById(R.id.tipoProducto);
